 ...
 * Last Update: 2025-01-09 19:11:00 UTC
 ...
 * ========================================
 */
if (!defined('C2P_VERSION'))      define('C2P_VERSION', '1.5.2'); // ✅ ATUALIZADO
...
function c2p_load_plugin() {
    ...
    /**
     * ✅ v1.5.1: REMOVIDO autoload.php (carregamento duplicado)
     * Todos os arquivos são carregados diretamente abaixo
     */
    ...
    $core_files = [
        ...
        'includes/class-custom-checkout.php', // ✅ NOVO: Checkout customizado
    ...
    // ✅ NOVO: Bootstrap custom checkout
...
function c2p_render_dashboard_page() {
    ...
    // ✅ NOVO: Info do checkout customizado
    ...
    echo '<td style="padding:12px;"><code>[c2p_checkout]</code> <button class="button button-small" onclick="navigator.clipboard.writeText(\'[c2p_checkout]\')">📋 Copiar</button></td>';
    echo '</tr>';
    echo '</tbody>';
    echo '</table>';
