...
// REMOVIDO: require_once __DIR__ . '/class-audit.php'; // auditoria
...
final class Settings {
    ...
    public static function render_page() : void {
        ...
        // (REMOVIDO) Snapshot lido do DB (c2p_settings)
        // (REMOVIDO) painel de auditoria: \C2P\Audit::render_panel();
